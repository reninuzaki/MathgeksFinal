...
public class BeginnerLevelActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void LoadData(View view){
        txtsssslvl1.setText(String.valueOf(CL1));
        txtsssslvl2.setText(String.valueOf(CL2));
        txtsssslvl3.setText(String.valueOf(CL3));
    }
    ...
    private void lockandunlocklevels() {
        ...
        CL1 = sharedPreferences.getInt(Constant.KEY_BEGN_LEVEL_1, 0);
        CL2 = sharedPreferences.getInt(Constant.KEY_BEGN_LEVEL_2, 0);
        CL3 = sharedPreferences.getInt(Constant.KEY_BEGN_LEVEL_3, 0);
        ...
        if (CategoryValue.equals("Beginner")){
            ...
            switch (v.getId()){
                case R.id.button6:
                    ...
                    Intent intentCompLevel1 = new Intent(BeginnerLevelActivity.this,QuizActivity.class);
                    intentCompLevel1.putExtra("Category",Questions.CATEGORY_BEGINNER);
                    intentCompLevel1.putExtra("Level",Questions.LEVEL1);
                    startActivity(intentCompLevel1);
                    BeginnerLevelActivity.this.finish();
                    break;

                case R.id.button8:

                    Intent intentCompLevel2 = new Intent(BeginnerLevelActivity.this,QuizActivity.class);
                    intentCompLevel2.putExtra("Category",Questions.CATEGORY_BEGINNER);
                    ...
                    break;
                case R.id.button9:
                    Intent intentCompLevel3 = new Intent(BeginnerLevelActivity.this,QuizActivity.class);
                    intentCompLevel3.putExtra("Category",Questions.CATEGORY_BEGINNER);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(BeginnerLevelActivity.this,CategoryActivity.class);
